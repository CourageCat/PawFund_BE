...
namespace PawFund.Application.UseCases.V1.Commands.Cat
{
    public sealed class CreateCatCommandHandler : ICommandHandler<Command.CreateCatCommand>
    {
        ...
        private readonly IRepositoryBase<Branch, Guid> _branchRepository;
        private readonly IEFUnitOfWork _efUnitOfWork;

        public CreateCatCommandHandler(IRepositoryBase<Domain.Entities.Cat, Guid> catRepository, IRepositoryBase<Branch, Guid> branchRepository, IEFUnitOfWork efUnitOfWork)
        {
