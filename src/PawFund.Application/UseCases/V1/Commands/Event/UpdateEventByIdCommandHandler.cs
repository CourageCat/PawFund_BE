...
namespace PawFund.Application.UseCases.V1.Commands.Event
{
    public sealed class UpdateEventByIdCommandHandler : ICommandHandler<Command.UpdateEventCommand>
    {
        ...
        public UpdateEventByIdCommandHandler(IRepositoryBase<Branch, Guid> branchRepository, IRepositoryBase<Domain.Entities.Event, Guid> eventRepository, IEFUnitOfWork efUnitOfWork, IDPUnitOfWork dPUnitOfWork)
        {
