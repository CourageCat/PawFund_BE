...
{
    public record CreateCatCommand(CatSex Sex, string Name, int Age, string Breed, decimal Size, string Color, string Description, Guid BranchId, List<IFormFile> Images) : ICommand;
