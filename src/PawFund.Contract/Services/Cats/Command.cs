...
{
    public record CreateCatCommand(CatSex Sex, string Name, string Age, string Breed, decimal Weight, string Color, string Description, Guid BranchId, List<IFormFile> Images) : ICommand;
