...
{
    public record CreateBranchCommand(string Name, string PhoneNumberOfBranch, string EmailOfBranch, string Description, string NumberHome, string StreetName, string Ward, string District, string Province, string PostalCode) : ICommand;
